...
namespace BusinessLayer.ValidationRules.AnnouncementValidationRules
{
    public class AnnouncementUpdateValidator : AbstractValidator<AnnouncementUpdateDto>
    {
        public AnnouncementUpdateValidator()
        {
            ...
            RuleFor(x => x.Content).MaximumLength(200).WithMessage("Duyuru İçeriği En Fazla 200 Karakter Olabilir");
            RuleFor(x => x.Content).MinimumLength(20).WithMessage("Duyuru İçeriği En Az 20 Karakter Olabilir");
        }
    }
}
